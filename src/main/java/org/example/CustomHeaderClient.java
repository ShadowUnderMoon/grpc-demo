...
/**
 * A simple client that like {@code io.grpc.examples.helloworld.HelloWorldClient}.
...
public class CustomHeaderClient {
  ...
  /**
   * A simple client method that like {@code io.grpc.examples.helloworld.HelloWorldClient}.
   */
